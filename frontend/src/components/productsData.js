...
const productsData = [
  {
    ...
    price: '₹110 - ₹260',
    description: 'Unveil the power of nature with Digesto, a meticulously crafted homeopathic formulation designed to restore harmony to your digestive system. Carefully blended using potent ingredients known for their therapeutic properties, Digesto addresses a myriad of digestive woes effectively and gently.',
    sections: [
      {
      ...
      {
        title: 'Dosage:',
        content: ['Enjoy the convenience of Digesto with a dosage of 1 to 2 tablespoonfuls after meals, recommended twice or thrice daily. This gentle regimen ensures continuous support for your digestive health throughout the day.']
      },
      {
        title: 'Ideal for:',
        content: [
  ...
  },
  {
    ...
    price: '₹120 - ₹280',
    description: 'Say goodbye to hair fall and embrace revitalized hair with HASLAB\'s Jaboran Drops. This unique formulation is crafted to strengthen hair, rejuvenate the scalp, and stimulate hair follicles, promoting robust growth and combating dandruff effectively.',
    sections: [
      {
        title: 'Key Benefits:',
        content: [
  ...
  },
  {
    ...
    dosage: 'Take 5 to 10 drops in water every half to one hour during acute episodes',
    price: '₹170',
    description: 'Find relief from sciatic nerve pain with DROX 24 Sciatica Drops, a specialized homeopathic formulation designed to alleviate symptoms associated with sciatica. Whether caused by a prolapsed disc or pressure on the sciatic nerve, DROX 24 targets paresthesias, cramps, and pain in the calves effectively.',
    sections: [
      {
  ...
  },
  {
    ...
    price: '₹105',
    description: 'Embrace freedom from allergies with Aidoaller Anti Allergic, a potent homeopathic blend crafted to alleviate a range of allergic symptoms effectively. From nasal congestion to skin reactions caused by environmental triggers, Aidoaller offers comprehensive relief to help you reclaim your comfort.',
    sections: [
      {
        title: 'Powerful Composition:',
        content: [
  ...
  },
  {
    ...
    price: '₹65',
    description: 'Embrace the freedom to enjoy your night out without worrying about the aftermath. GoParty is a potent homeopathic blend designed to alleviate a range of hangover symptoms effectively. From headaches to nausea caused by alcohol consumption, GoParty offers comprehensive relief to help you reclaim your comfort and enjoy your day after a night of celebration.',
    sections: [
      {
        title: 'Powerful Composition:',
        content: [
